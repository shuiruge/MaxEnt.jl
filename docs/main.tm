...
<\body>
  ...
  <\lemma>
    ...
    <\equation>
      <big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)>
      x=\<sigma\><rsub|\<alpha\>>.
    </equation>
    ...
    And variance<\footnote>
      ...
      <\align>
        <tformat|<table|<row|<cell|<around*|(|<frac|\<partial\>|\<partial\>b<rsub|\<alpha\>>>|)><rsup|2>p<rsub|\<alpha\>><around*|(|x|)>=>|<cell|<frac|\<partial\>|\<partial\>b<rsub|\<alpha\>>><around*|[|p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)>|]>>>|<row|<cell|=>|<cell|<frac|\<partial\>p<rsub|\<alpha\>>|\<partial\>b<rsub|\<alpha\>>><around*|(|x|)><around*|(|x-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)>-p<rsub|\<alpha\>><around*|(|x|)>\<sigma\><rprime|'><around*|(|b<rsub|\<alpha\>>|)>>>|<row|<cell|=>|<cell|p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)><rsup|2>-p<rsub|\<alpha\>><around*|(|x|)>\<sigma\><around*|(|b<rsub|\<alpha\>>|)><around*|(|1-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)>.>>>>
      </align>

      Thus,

      <\align>
        <tformat|<table|<row|<cell|<big|sum><rsub|x><around*|(|<frac|\<partial\>|\<partial\>b<rsub|\<alpha\>>>|)><rsup|2>p<rsub|\<alpha\>><around*|(|x|)>=>|<cell|<big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)><rsup|2>-<big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)>\<sigma\><around*|(|b<rsub|\<alpha\>>|)><around*|(|1-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)>>>|<row|<cell|<around*|(|<frac|\<partial\>|\<partial\>b<rsub|\<alpha\>>>|)><rsup|2><big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)>=>|<cell|<big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)><rsup|2>-<around*|(|<big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)>|)>\<sigma\><around*|(|b<rsub|\<alpha\>>|)><around*|(|1-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)>>>|<row|<cell|0=>|<cell|<big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)><rsup|2>-\<sigma\><around*|(|b<rsub|\<alpha\>>|)><around*|(|1-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)>.>>>>
      </align>
    </footnote>

    <\equation>
      <big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)>
      <around*|(|x-\<sigma\><rsub|\<alpha\>>|)><rsup|2>=\<sigma\><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)>.
    </equation>
    ...
    3-momentum is<\footnote>
      ...
      <\align>
        <tformat|<table|<row|<cell|<around*|(|<frac|\<partial\>|\<partial\>b<rsub|\<alpha\>>>|)><rsup|3>p<rsub|\<alpha\>><around*|(|x|)>=>|<cell|<around*|(|<frac|\<partial\>|\<partial\>b<rsub|\<alpha\>>>|)><around*|[|p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)><rsup|2>-p<rsub|\<alpha\>><around*|(|x|)>\<sigma\><around*|(|b<rsub|\<alpha\>>|)><around*|(|1-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)>|]>>>|<row|<cell|=>|<cell|<frac|\<partial\>p<rsub|\<alpha\>>|\<partial\>b<rsub|\<alpha\>>><around*|(|x|)><around*|(|x-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)><rsup|2>-p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)>\<sigma\><rprime|'><around*|(|b<rsub|\<alpha\>>|)>>>|<row|<cell|>|<cell|-<frac|\<partial\>p<rsub|\<alpha\>>|\<partial\>b<rsub|\<alpha\>>><around*|(|x|)>\<sigma\><around*|(|b<rsub|\<alpha\>>|)><around*|(|1-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)>-p<rsub|\<alpha\>><around*|(|x|)>\<sigma\><rprime|'><around*|(|b<rsub|\<alpha\>>|)><around*|(|1-\<sigma\><around*|(|b<rsub|\<alpha\>>|)>|)>+p<rsub|\<alpha\>><around*|(|x|)>\<sigma\><around*|(|b<rsub|\<alpha\>>|)>\<sigma\><rprime|'><around*|(|b<rsub|\<alpha\>>|)>>>|<row|<cell|=>|<cell|p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><rsub|\<alpha\>>|)><rsup|3>-p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><rsub|\<alpha\>>|)>\<sigma\><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)>>>|<row|<cell|>|<cell|-p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><rsub|\<alpha\>>|)>\<sigma\><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)>-p<rsub|\<alpha\>><around*|(|x|)>\<sigma\><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)><rsup|2>+p<rsub|\<alpha\>><around*|(|x|)>\<sigma\><rsup|2><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)>>>|<row|<cell|=>|<cell|p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><rsub|\<alpha\>>|)><rsup|3>-2p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><rsub|\<alpha\>>|)>\<sigma\><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)>-p<rsub|\<alpha\>><around*|(|x|)>\<sigma\><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)><rsup|2>+p<rsub|\<alpha\>><around*|(|x|)>\<sigma\><rsup|2><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)>>>>>
      </align>

      <\align>
        <tformat|<table|<row|<cell|<big|sum><rsub|x><around*|(|<frac|\<partial\>|\<partial\>b<rsub|\<alpha\>>>|)><rsup|3>p<rsub|\<alpha\>><around*|(|x|)>=>|<cell|<big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><rsub|\<alpha\>>|)><rsup|3>-2<big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><rsub|\<alpha\>>|)>\<sigma\><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)>>>|<row|<cell|>|<cell|-<big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)>\<sigma\><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)><rsup|2>+<big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)>\<sigma\><rsup|2><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)>>>|<row|<cell|0=>|<cell|<big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><rsub|\<alpha\>>|)><rsup|3>-0-\<sigma\><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)><rsup|2>+\<sigma\><rsup|2><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)>.>>>>
      </align>

      Thus

      <\equation*>
        <big|sum><rsub|x>p<rsub|\<alpha\>><around*|(|x|)><around*|(|x-\<sigma\><rsub|\<alpha\>>|)><rsup|3>=\<sigma\><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)><rsup|2>-\<sigma\><rsup|2><rsub|\<alpha\>><around*|(|1-\<sigma\><rsub|\<alpha\>>|)>.
      </equation*>
    </footnote>
  ...
  <\lemma>
    Up to the 1st-order of <math|W>,<\footnote>
      ...
      <\align>
        <tformat|<table|<row|<cell|<big|sum><rsub|x>p<rsub|E><around*|(|x|)>x<rsup|\<gamma\>>=>|<cell|<big|sum><rsub|x>p<rsub|0><around*|(|x|)>x<rsup|\<gamma\>>+<big|sum><rsub|x>p<rsub|1><around*|(|x|)>x<rsup|\<gamma\>>>>|<row|<cell|=>|<cell|\<sigma\><rsup|\<gamma\>>+<frac|1|2>W<rsub|\<alpha\>\<beta\>><big|sum><rsub|x>p<rsub|0><around*|(|x|)><around*|(|x<rsup|\<alpha\>>-\<sigma\><rsup|\<alpha\>>|)><around*|(|x<rsup|\<beta\>>-\<sigma\><rsup|\<beta\>>|)>x<rsup|\<gamma\>>-<frac|1|2>W<rsub|\<alpha\>\<alpha\>>\<sigma\><rsup|\<alpha\>><around*|(|1-\<sigma\><rsup|\<alpha\>>|)><big|sum><rsub|x>p<rsub|0><around*|(|x|)>x<rsup|\<gamma\>>>>|<row|<cell|=>|<cell|\<sigma\><rsup|\<gamma\>>+<frac|1|2>W<rsub|\<alpha\>\<beta\>><big|sum><rsub|x>p<rsub|0><around*|(|x|)><around*|(|x<rsup|\<alpha\>>-\<sigma\><rsup|\<alpha\>>|)><around*|(|x<rsup|\<beta\>>-\<sigma\><rsup|\<beta\>>|)><around*|(|x<rsup|\<gamma\>>-\<sigma\><rsup|\<gamma\>>|)>-<frac|1|2>W<rsub|\<alpha\>\<alpha\>>\<sigma\><rsup|\<alpha\>><around*|(|1-\<sigma\><rsup|\<alpha\>>|)>\<sigma\><rsup|\<gamma\>>>>|<row|<cell|>|<cell|+<frac|1|2>W<rsub|\<alpha\>\<beta\>><big|sum><rsub|x>p<rsub|0><around*|(|x|)><around*|(|x<rsup|\<alpha\>>-\<sigma\><rsup|\<alpha\>>|)><around*|(|x<rsup|\<beta\>>-\<sigma\><rsup|\<beta\>>|)>\<sigma\><rsup|\<gamma\>>>>|<row|<cell|=>|<cell|\<sigma\><rsup|\<gamma\>>+<frac|1|2>W<rsub|\<gamma\>\<gamma\>><around*|[|\<sigma\><rsup|\<gamma\>><around*|(|1-\<sigma\><rsup|\<gamma\>>|)><rsup|2>-\<sigma\><rsup|\<gamma\>><rsup|2><around*|(|1-\<sigma\><rsup|\<gamma\>>|)>|]>-<frac|1|2>W<rsub|\<alpha\>\<alpha\>>\<sigma\><rsup|\<alpha\>><around*|(|1-\<sigma\><rsup|\<alpha\>>|)>\<sigma\><rsup|\<gamma\>>+<frac|1|2>W<rsub|\<alpha\>\<alpha\>>W<rsub|\<alpha\>\<alpha\>>\<sigma\><rsup|\<alpha\>><around*|(|1-\<sigma\><rsup|\<alpha\>>|)>\<sigma\><rsup|\<gamma\>>>>|<row|<cell|=>|<cell|\<sigma\><rsup|\<gamma\>>+<frac|1|2>W<rsub|\<gamma\>\<gamma\>><around*|[|\<sigma\><rsup|\<gamma\>><around*|(|1-\<sigma\><rsup|\<gamma\>>|)><rsup|2>-\<sigma\><rsup|\<gamma\>><rsup|2><around*|(|1-\<sigma\><rsup|\<gamma\>>|)>|]>.>>>>
      </align>
    </footnote>

    <\equation>
      <big|sum><rsub|x>p<rsub|E><around*|(|x|)>x<rsup|\<gamma\>>=\<sigma\><rsup|\<gamma\>>+<frac|1|2>W<rsub|\<gamma\>\<gamma\>><around*|[|\<sigma\><rsup|\<gamma\>><around*|(|1-\<sigma\><rsup|\<gamma\>>|)><rsup|2>-\<sigma\><rsup|\<gamma\>><rsup|2><around*|(|1-\<sigma\><rsup|\<gamma\>>|)>|]>.
    </equation>
